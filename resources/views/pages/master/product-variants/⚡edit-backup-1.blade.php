...
<div class="p-4 md:p-8 max-w-7xl mx-auto space-y-6" x-data="variantForm" @updated.window="triggerAlert('Product variants updated successfully!', 'alert-success')">

    <div class="rounded-xl border border-base-200 bg-base-100 shadow-sm p-6 md:p-8">
        <h2 class="text-xl font-bold border-b pb-4 mb-6">Update Product Variant</h2>
        ...
        <form class="space-y-6" wire:submit="update">
            <div class="form-control w-full">
                ...
                <select class="select select-bordered w-full @error('product_id') input-error @enderror" wire:model="product_id" disabled>
