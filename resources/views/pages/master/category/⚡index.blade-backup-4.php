...
<div x-data="{ open: $wire.entangle('showModal') }" @category-saved.window="open = false" class="p-4 md:p-8 max-w-7xl mx-auto space-y-6">
    <div
        ...
        <button @click="name = ''; open = !open; $wire.openModal()" class="btn btn-primary shadow-sm">
    ...
    <div class="modal" :class="{ 'modal-open': open }" x-show="open" x-transition role="dialog">
        <div class="modal-box max-w-md">
            ...
            <div class="modal-action border-t pt-3">
                <button @click="open = false; name = ''" wire:click="closeModal" class="btn btn-ghost">Cancel</button>
